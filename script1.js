//Products to display box1(Product on cart section)
/*const arr = [
        {
    ...
    const calculate =()=>{
        ...
        if(sum == 0){
            document.querySelector("#total").innerHTML = `₹${sum+0}`;
        }
        else{
            document.querySelector("#total").innerHTML = `₹${sum+50}`;
        }
    }
    calculate();*/
    const arr = [
